      ...
      <div className="contact-container">
        ...
        <div className="payment-qr-section">
          <div className="payment-qr-header">
            ...
            <p>Scan QR codes below to make quick and secure payments</p>
          </div>
          ...
          <div className="qr-codes-grid">
            <div className="qr-code-item">
              ...
              <div className="qr-code-container">
                <img src="/images/esewa-qr.png" alt="eSewa QR Code" className="qr-code-image" />
              </div>
              <div className="qr-code-details">
                <p className="account-name">Dinesh Laal Shrestha</p>
                <p className="account-info">ID: 9841241832</p>
              </div>
            </div>
            ...
            <div className="qr-code-item">
              ...
              <div className="qr-code-container">
                <img src="/images/nimb-qr.jpg" alt="NIMB Bank QR Code" className="qr-code-image" />
              </div>
              <div className="qr-code-details">
                <p className="account-name">Dinesh Laal Shrestha</p>
